...
$(ObjDir)/diff_eq_tb_2.cpp_pre.cpp.tb.o : diff_eq_tb_2.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling diff_eq_tb_2.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/diffeq.cpp_pre.cpp.tb.o : diffeq.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling diffeq.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
