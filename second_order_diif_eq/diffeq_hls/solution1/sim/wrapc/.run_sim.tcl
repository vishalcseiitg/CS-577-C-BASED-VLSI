...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "diffeq.autotvin.dat"
	set constFileTvOut       "diffeq.autotvout.dat"
	set constFileHdlTvIn     "diffeq.autohdltvin.dat"
	set constFileHdlTvOut    "diffeq.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
