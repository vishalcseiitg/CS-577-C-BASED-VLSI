...
if {[file isfile sequence.autotvin.dat]} {
	file delete -force sequence.autotvin.dat
}

if {[file isfile sequence.autotvout.dat]} {
	file delete -force sequence.autotvout.dat
}
