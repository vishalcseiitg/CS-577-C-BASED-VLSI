...
#define AUTOTB_TVOUT_n "../tv/cdatafile/c.sequence.autotvout_n.dat"
...
extern "C"
void sequence_hw_stub_wrapper(hls::sim::Byte<4>);

extern "C"
void apatb_sequence_hw(hls::sim::Byte<4> __xlx_apatb_param_n)
{
  ...
  try {
    ...
    sequence_hw_stub_wrapper(__xlx_apatb_param_n);
