...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "funArr.autotvin.dat"
	set constFileTvOut       "funArr.autotvout.dat"
	set constFileHdlTvIn     "funArr.autohdltvin.dat"
	set constFileHdlTvOut    "funArr.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
