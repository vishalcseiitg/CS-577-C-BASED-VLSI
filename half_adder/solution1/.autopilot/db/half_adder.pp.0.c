...
# 269 "/home/Vitis_HLS/2022.2/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 2 "<built-in>" 2
# 1 "half_adder.c" 2
__attribute__((sdx_kernel("half_adder", 0))) void half_adder(int a, int b, int *sum, int *carry) {
#line 14 "/home/vishal/half_adder/solution1/csynth.tcl"
