...
$(ObjDir)/half_adder_tb.c_pre.c.tb.o : half_adder_tb.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) half_adder_tb.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/half_adder.c_pre.c.tb.o : half_adder.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) half_adder.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
